// Vendored + patched build of rosu-pp-js (MIT licensed) for browser/content-script use.
// Source: https://github.com/MaxOhn/rosu-pp-js (npm package rosu-pp-js@4.0.1, "nodejs" target).
// Patched: Node `require`("util"/"fs"/"path") and __dirname replaced with browser
// globals + an async fetch()-based WebAssembly loader (see __init at the bottom).
 ...
 * @enum {0 | 1}
 */
module.exports.HitResultGenerator = Object.freeze({
    /**
...
module.exports.__wbg_getwithrefkey_2ba87e556248ad3d = function(arg0, arg1) {
...
module.exports.__wbg_set_4c6c65d3d6468e8a = function(arg0, arg1, arg2) {
...
let __wasmInitPromise = null;
function __initRosuPpWasm(wasmUrl) {
    if (__wasmInitPromise) return __wasmInitPromise;
    __wasmInitPromise = fetch(wasmUrl)
    ...
    return __wasmInitPromise;
}
module.exports.__init = __initRosuPpWasm;


global.RosuPP = module.exports;
